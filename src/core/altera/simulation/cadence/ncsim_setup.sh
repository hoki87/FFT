...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/submodules/fft_fft_ii_0_opt_twi5.hex ./
  cp -f $QSYS_SIMDIR/submodules/fft_fft_ii_0_opt_twi1.hex ./
  cp -f $QSYS_SIMDIR/submodules/fft_fft_ii_0_opt_twr4.hex ./
  cp -f $QSYS_SIMDIR/submodules/fft_fft_ii_0_opt_twr5.hex ./
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/fft_fft_ii_0.vo" -work fft_ii_0 -cdslib ./cds_libs/fft_ii_0.cds.lib
