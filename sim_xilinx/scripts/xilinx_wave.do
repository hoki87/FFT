...
add wave -noupdate -format Analog-Step -height 74 -max 4.0 -radix decimal /fft_tb/FFT/postproc_u/dout_i
add wave -noupdate -radix decimal /fft_tb/FFT/postproc_u/dout_q
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {82745000 ps} 0} {{Cursor 2} {33037240 ps} 0} {{Cursor 3} {236852918 ps} 0}
...
update
WaveRestoreZoom {236649401 ps} {237060599 ps}
