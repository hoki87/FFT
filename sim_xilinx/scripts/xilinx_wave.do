...
add wave -noupdate -format Analog-Step -height 74 -max 64.0 -min -64.0 -radix decimal /fft_tb/FFT/xilinx_fft/xn_re
add wave -noupdate -format Analog-Step -height 74 -max 64.0 -min -64.0 -radix decimal /fft_tb/FFT/xilinx_fft/xn_im
...
add wave -noupdate -format Analog-Step -height 74 -max 32290.0 -min -31987.0 -radix decimal /fft_tb/FFT/postproc_u/dout_i
add wave -noupdate -radix decimal /fft_tb/FFT/postproc_u/dout_q
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {57505100 ps} 0} {{Cursor 2} {199895000 ps} 0} {{Cursor 3} {194835000 ps} 0}
...
update
WaveRestoreZoom {26844104 ps} {446845896 ps}
