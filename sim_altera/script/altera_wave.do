...
add wave -noupdate /fft_tb/IFFT/postproc_u/buf_rd_en
...
add wave -noupdate -format Analog-Step -height 74 -max 126.99999999999997 -min -128.0 -radix decimal -childformat {{{/fft_tb/IFFT/postproc_u/dout_q[15]} -radix decimal} {{/fft_tb/IFFT/postproc_u/dout_q[14]} -radix decimal} {{/fft_tb/IFFT/postproc_u/dout_q[13]} -radix decimal} {{/fft_tb/IFFT/postproc_u/dout_q[12]} -radix decimal} {{/fft_tb/IFFT/postproc_u/dout_q[11]} -radix decimal} {{/fft_tb/IFFT/postproc_u/dout_q[10]} -radix decimal} {{/fft_tb/IFFT/postproc_u/dout_q[9]} -radix decimal} {{/fft_tb/IFFT/postproc_u/dout_q[8]} -radix decimal} {{/fft_tb/IFFT/postproc_u/dout_q[7]} -radix decimal} {{/fft_tb/IFFT/postproc_u/dout_q[6]} -radix decimal} {{/fft_tb/IFFT/postproc_u/dout_q[5]} -radix decimal} {{/fft_tb/IFFT/postproc_u/dout_q[4]} -radix decimal} {{/fft_tb/IFFT/postproc_u/dout_q[3]} -radix decimal} {{/fft_tb/IFFT/postproc_u/dout_q[2]} -radix decimal} {{/fft_tb/IFFT/postproc_u/dout_q[1]} -radix decimal} {{/fft_tb/IFFT/postproc_u/dout_q[0]} -radix decimal}} -subitemconfig {{/fft_tb/IFFT/postproc_u/dout_q[15]} {-height 15 -radix decimal} {/fft_tb/IFFT/postproc_u/dout_q[14]} {-height 15 -radix decimal} {/fft_tb/IFFT/postproc_u/dout_q[13]} {-height 15 -radix decimal} {/fft_tb/IFFT/postproc_u/dout_q[12]} {-height 15 -radix decimal} {/fft_tb/IFFT/postproc_u/dout_q[11]} {-height 15 -radix decimal} {/fft_tb/IFFT/postproc_u/dout_q[10]} {-height 15 -radix decimal} {/fft_tb/IFFT/postproc_u/dout_q[9]} {-height 15 -radix decimal} {/fft_tb/IFFT/postproc_u/dout_q[8]} {-height 15 -radix decimal} {/fft_tb/IFFT/postproc_u/dout_q[7]} {-height 15 -radix decimal} {/fft_tb/IFFT/postproc_u/dout_q[6]} {-height 15 -radix decimal} {/fft_tb/IFFT/postproc_u/dout_q[5]} {-height 15 -radix decimal} {/fft_tb/IFFT/postproc_u/dout_q[4]} {-height 15 -radix decimal} {/fft_tb/IFFT/postproc_u/dout_q[3]} {-height 15 -radix decimal} {/fft_tb/IFFT/postproc_u/dout_q[2]} {-height 15 -radix decimal} {/fft_tb/IFFT/postproc_u/dout_q[1]} {-height 15 -radix decimal} {/fft_tb/IFFT/postproc_u/dout_q[0]} {-height 15 -radix decimal}} /fft_tb/IFFT/postproc_u/dout_q
add wave -noupdate -divider PreProc
...
WaveRestoreCursors {{Cursor 1} {3775475 ns} 0} {{Cursor 2} {216045 ns} 0} {{Cursor 3} {935615 ns} 0}
