...
add wave -noupdate -radix unsigned /fft_tb/ifft_source/fs_ratio
...
add wave -noupdate -radix unsigned /fft_tb/IFFT/preproc_u/cache_waddr
...
add wave -noupdate -format Analog-Step -height 74 -max 32767.0 -radix decimal /fft_tb/IFFT/altera_fft/sink_real
...
add wave -noupdate -radix decimal -childformat {{{/fft_tb/IFFT/altera_fft/source_real[15]} -radix hexadecimal} {{/fft_tb/IFFT/altera_fft/source_real[14]} -radix hexadecimal} {{/fft_tb/IFFT/altera_fft/source_real[13]} -radix hexadecimal} {{/fft_tb/IFFT/altera_fft/source_real[12]} -radix hexadecimal} {{/fft_tb/IFFT/altera_fft/source_real[11]} -radix hexadecimal} {{/fft_tb/IFFT/altera_fft/source_real[10]} -radix hexadecimal} {{/fft_tb/IFFT/altera_fft/source_real[9]} -radix hexadecimal} {{/fft_tb/IFFT/altera_fft/source_real[8]} -radix hexadecimal} {{/fft_tb/IFFT/altera_fft/source_real[7]} -radix hexadecimal} {{/fft_tb/IFFT/altera_fft/source_real[6]} -radix hexadecimal} {{/fft_tb/IFFT/altera_fft/source_real[5]} -radix hexadecimal} {{/fft_tb/IFFT/altera_fft/source_real[4]} -radix hexadecimal} {{/fft_tb/IFFT/altera_fft/source_real[3]} -radix hexadecimal} {{/fft_tb/IFFT/altera_fft/source_real[2]} -radix hexadecimal} {{/fft_tb/IFFT/altera_fft/source_real[1]} -radix hexadecimal} {{/fft_tb/IFFT/altera_fft/source_real[0]} -radix hexadecimal}} -subitemconfig {{/fft_tb/IFFT/altera_fft/source_real[15]} {-height 15 -radix hexadecimal} {/fft_tb/IFFT/altera_fft/source_real[14]} {-height 15 -radix hexadecimal} {/fft_tb/IFFT/altera_fft/source_real[13]} {-height 15 -radix hexadecimal} {/fft_tb/IFFT/altera_fft/source_real[12]} {-height 15 -radix hexadecimal} {/fft_tb/IFFT/altera_fft/source_real[11]} {-height 15 -radix hexadecimal} {/fft_tb/IFFT/altera_fft/source_real[10]} {-height 15 -radix hexadecimal} {/fft_tb/IFFT/altera_fft/source_real[9]} {-height 15 -radix hexadecimal} {/fft_tb/IFFT/altera_fft/source_real[8]} {-height 15 -radix hexadecimal} {/fft_tb/IFFT/altera_fft/source_real[7]} {-height 15 -radix hexadecimal} {/fft_tb/IFFT/altera_fft/source_real[6]} {-height 15 -radix hexadecimal} {/fft_tb/IFFT/altera_fft/source_real[5]} {-height 15 -radix hexadecimal} {/fft_tb/IFFT/altera_fft/source_real[4]} {-height 15 -radix hexadecimal} {/fft_tb/IFFT/altera_fft/source_real[3]} {-height 15 -radix hexadecimal} {/fft_tb/IFFT/altera_fft/source_real[2]} {-height 15 -radix hexadecimal} {/fft_tb/IFFT/altera_fft/source_real[1]} {-height 15 -radix hexadecimal} {/fft_tb/IFFT/altera_fft/source_real[0]} {-height 15 -radix hexadecimal}} /fft_tb/IFFT/altera_fft/source_real
add wave -noupdate -radix decimal /fft_tb/IFFT/altera_fft/source_imag
...
add wave -noupdate /fft_tb/IFFT/postproc_u/fft_type
add wave -noupdate /fft_tb/IFFT/postproc_u/cp_type
add wave -noupdate -radix unsigned /fft_tb/IFFT/postproc_u/fft_num
add wave -noupdate -radix unsigned /fft_tb/IFFT/postproc_u/fs_ratio
add wave -noupdate /fft_tb/IFFT/postproc_u/fst_cp
add wave -noupdate /fft_tb/IFFT/postproc_u/din_h
add wave -noupdate /fft_tb/IFFT/postproc_u/din_v
add wave -noupdate -radix decimal /fft_tb/IFFT/postproc_u/din_i
add wave -noupdate -radix decimal /fft_tb/IFFT/postproc_u/din_q
...
add wave -noupdate -radix unsigned /fft_tb/IFFT/postproc_u/cache_fs_ratio
...
add wave -noupdate -radix unsigned -childformat {{{/fft_tb/IFFT/postproc_u/buf_rd_cnt[6]} -radix unsigned} {{/fft_tb/IFFT/postproc_u/buf_rd_cnt[5]} -radix unsigned} {{/fft_tb/IFFT/postproc_u/buf_rd_cnt[4]} -radix unsigned} {{/fft_tb/IFFT/postproc_u/buf_rd_cnt[3]} -radix unsigned} {{/fft_tb/IFFT/postproc_u/buf_rd_cnt[2]} -radix unsigned} {{/fft_tb/IFFT/postproc_u/buf_rd_cnt[1]} -radix unsigned} {{/fft_tb/IFFT/postproc_u/buf_rd_cnt[0]} -radix unsigned}} -subitemconfig {{/fft_tb/IFFT/postproc_u/buf_rd_cnt[6]} {-height 15 -radix unsigned} {/fft_tb/IFFT/postproc_u/buf_rd_cnt[5]} {-height 15 -radix unsigned} {/fft_tb/IFFT/postproc_u/buf_rd_cnt[4]} {-height 15 -radix unsigned} {/fft_tb/IFFT/postproc_u/buf_rd_cnt[3]} {-height 15 -radix unsigned} {/fft_tb/IFFT/postproc_u/buf_rd_cnt[2]} {-height 15 -radix unsigned} {/fft_tb/IFFT/postproc_u/buf_rd_cnt[1]} {-height 15 -radix unsigned} {/fft_tb/IFFT/postproc_u/buf_rd_cnt[0]} {-height 15 -radix unsigned}} /fft_tb/IFFT/postproc_u/buf_rd_cnt
...
add wave -noupdate /fft_tb/FFT/preproc_u/din_v
...
add wave -noupdate -radix decimal /fft_tb/FFT/preproc_u/dout_real
...
add wave -noupdate -radix decimal -childformat {{{/fft_tb/FFT/altera_fft/source_real[15]} -radix decimal} {{/fft_tb/FFT/altera_fft/source_real[14]} -radix decimal} {{/fft_tb/FFT/altera_fft/source_real[13]} -radix decimal} {{/fft_tb/FFT/altera_fft/source_real[12]} -radix decimal} {{/fft_tb/FFT/altera_fft/source_real[11]} -radix decimal} {{/fft_tb/FFT/altera_fft/source_real[10]} -radix decimal} {{/fft_tb/FFT/altera_fft/source_real[9]} -radix decimal} {{/fft_tb/FFT/altera_fft/source_real[8]} -radix decimal} {{/fft_tb/FFT/altera_fft/source_real[7]} -radix decimal} {{/fft_tb/FFT/altera_fft/source_real[6]} -radix decimal} {{/fft_tb/FFT/altera_fft/source_real[5]} -radix decimal} {{/fft_tb/FFT/altera_fft/source_real[4]} -radix decimal} {{/fft_tb/FFT/altera_fft/source_real[3]} -radix decimal} {{/fft_tb/FFT/altera_fft/source_real[2]} -radix decimal} {{/fft_tb/FFT/altera_fft/source_real[1]} -radix decimal} {{/fft_tb/FFT/altera_fft/source_real[0]} -radix decimal}} -subitemconfig {{/fft_tb/FFT/altera_fft/source_real[15]} {-height 15 -radix decimal} {/fft_tb/FFT/altera_fft/source_real[14]} {-height 15 -radix decimal} {/fft_tb/FFT/altera_fft/source_real[13]} {-height 15 -radix decimal} {/fft_tb/FFT/altera_fft/source_real[12]} {-height 15 -radix decimal} {/fft_tb/FFT/altera_fft/source_real[11]} {-height 15 -radix decimal} {/fft_tb/FFT/altera_fft/source_real[10]} {-height 15 -radix decimal} {/fft_tb/FFT/altera_fft/source_real[9]} {-height 15 -radix decimal} {/fft_tb/FFT/altera_fft/source_real[8]} {-height 15 -radix decimal} {/fft_tb/FFT/altera_fft/source_real[7]} {-height 15 -radix decimal} {/fft_tb/FFT/altera_fft/source_real[6]} {-height 15 -radix decimal} {/fft_tb/FFT/altera_fft/source_real[5]} {-height 15 -radix decimal} {/fft_tb/FFT/altera_fft/source_real[4]} {-height 15 -radix decimal} {/fft_tb/FFT/altera_fft/source_real[3]} {-height 15 -radix decimal} {/fft_tb/FFT/altera_fft/source_real[2]} {-height 15 -radix decimal} {/fft_tb/FFT/altera_fft/source_real[1]} {-height 15 -radix decimal} {/fft_tb/FFT/altera_fft/source_real[0]} {-height 15 -radix decimal}} /fft_tb/FFT/altera_fft/source_real
...
add wave -noupdate -max 253.0 -min -3.0 -radix decimal /fft_tb/FFT/postproc_u/dout_i
add wave -noupdate -radix decimal /fft_tb/FFT/postproc_u/dout_q
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {3666805 ns} 0} {{Cursor 2} {4426125 ns} 0} {{Cursor 3} {544835 ns} 0}
