...
add wave -noupdate -format Analog-Step -height 74 -max 16.0 -min -16.0 -radix decimal /fft_tb/FFT/preproc_u/dout_real
add wave -noupdate -format Analog-Step -height 74 -max 16.0 -min -16.0 -radix decimal /fft_tb/FFT/preproc_u/dout_imag
...
add wave -noupdate -format Analog-Step -height 74 -max 3.0 -min -1.0 -radix decimal /fft_tb/FFT/postproc_u/dout_i
add wave -noupdate -radix decimal /fft_tb/FFT/postproc_u/dout_q
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {665 ns} 0} {{Cursor 2} {378255 ns} 0} {{Cursor 3} {184035 ns} 0}
